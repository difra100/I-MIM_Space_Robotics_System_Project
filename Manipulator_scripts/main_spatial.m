...
[q_f q_ss, dq_ss, ddq_ss, pointss, tot_time] = get_trajectory_in_orbit(q_i, q_ss, dq_ss, ddq_ss, pointss, tot_time, earth_target, M, V, B, C, p_EE);


disp(' Mars pointing trajectory ')
[q_f q_ss, dq_ss, ddq_ss, pointss, tot_time] = get_trajectory_in_orbit(q_f, q_ss, dq_ss, ddq_ss, pointss, tot_time, mars_target, M, V, B, C, p_EE);
